...
$cod_personal=$_GET['cod_personal'];// Recuepramos lo que nos llega del otro formulario
include_once("basededatos.php");
$res=mysql_query("SELECT * FROM personal WHERE cod_personal='$cod_personal'");
    ...
    <div class="contenido">
        ...
        <center>
            <form action="personal-actualizar.php" method="post">
                ...
                <label>Carnet
                <br />
                    <input type="text" name="ci" value="<?php echo $reg['cod_personal']?>"/>
                </label>
                <br />
                <label>Nombre
                <br />
                ...
                <label>Telefono
                <br />
                    <input type="text" name="telefono"  maxlength="8" max="99999999" value="<?php echo $reg['telefono']?>"/>
                </label>
                <br />
                <br />
